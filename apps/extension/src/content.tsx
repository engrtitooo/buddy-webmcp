...
import { ExtensionRealtimeSessionProvider } from './realtime-provider';
...
if(!document.getElementById(HOST_ID)){
  ...
  createRoot(mount).render(<BuddyApp adapter={new WebMCPAdapter()} provider={new ExtensionAgentProvider()} realtimeProvider={new ExtensionRealtimeSessionProvider()} siteName={location.hostname.replace(/^www\./,'')}/>);
}
